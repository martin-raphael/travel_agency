    ...
    >
      ...
      >
        <CampSite
          ...
          peopleJoined="300+ visited"
        />
        <CampSite
         backgroundImage="bg-bg-img-2"
         title="The Ranch Camp site"
         subtitle="Kirinyaga, Kenya"
         peopleJoined="800+ visited" />
      </div>
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
          ...
          xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
            <h2 className="regular-24 md:regular-32 2xl:regular-64 capitalize text-white">
              <strong>Feeling lost</strong> and you want to explore the Central Kenya?
            </h2>
            <p className="regular-14 xl:regular-16 mt-5 text-white">Starting from the anxiety of the climbers when visiting a new climbing location, the possibility of getting lost is very large.
               That&apos s why we are here for those of you who want to start an adventure</p>
